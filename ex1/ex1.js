function initUI() {
    ...
    var handleClick = function() {
        ...
        if (!validateWorkEntry(description, Number(minutes))) {
...
function validateWorkEntry(description, minutes) {
    console.log('validateWorkEntry');
    if (description.length >= 5 && minutes > 0 && minutes <= 600) {
        console.log('isValidateWorkEntry');
        return true;
    } else {
        console.log('notValidateWorkEntry');
        return false;
    }
    // TODO
}
...
function addWorkToProject(projectId, description, minutes) {
    console.log('addWorkToProject');

    console.log(Number(projectId), description, Number(minutes));
...
function updateWorkLogTotalTime() {
    console.log('updateWorkLogTotalTime');
    if (projects.time > 0) {
